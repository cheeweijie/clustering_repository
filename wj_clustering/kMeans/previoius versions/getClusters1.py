...
for i in range(num_clusters):
    ...
    for ind in order_centroids[i, :6]:
    	print "1 {}".format(terms[ind])
    	raw_input()
    	print "2 {}".format(terms[ind].split(' '))
    	raw_input()
    	print "3 {}".format(vocab_frame.ix[terms[ind].split(' ')])
    	raw_input()
    	print "4 {}".format(vocab_frame.ix[terms[ind].split(' ')].values)
    	raw_input()
    	print "5 {}".format(vocab_frame.ix[terms[ind].split(' ')].values.tolist())
    	raw_input()
        print('6 %s' % vocab_frame.ix[terms[ind].split(' ')].values.tolist()[0][0].encode('utf-8', 'ignore'))
        raw_input()
    print
    print
